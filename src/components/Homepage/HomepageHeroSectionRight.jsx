					...
					<div className="row">
						<div className="col-sm-12 col-md-6 mb-3 portfolio-item">
							<a className="portfolio-item-image" href="/discogs-view" target="_blank">
								<img alt="vinyl-img" src={vinylRecordImg} />
							</a>
						</div>
						<div className="col-sm-12 col-md-6 mb-3 portfolio-item">
							<a className="portfolio-item-image" href="/discogs-data" target="_blank">
								<img
									alt="d3-img"
									src="https://camo.githubusercontent.com/722a5cc12c7d40231ebeb8ca6facdc8547e2abf7/68747470733a2f2f64336a732e6f72672f6c6f676f2e737667"
								/>
							</a>
						</div>
						<div className="col-sm-12 col-md-6 mb-3 portfolio-item">
							<a className="portfolio-item-image">
								<img alt="tbd-1" src="http://via.placeholder.com/250x250" />
							</a>
						</div>
						<div className="col-sm-12 col-md-6 mb-3 portfolio-item">
							<a className="portfolio-item-image">
								<img alt="tbd-2" src="http://via.placeholder.com/250x250" />
							</a>
						</div>
					</div>
				</div>
